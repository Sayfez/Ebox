  ...
  return (
    <nav className="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
      ...
      <div className="navbar-nav align-items-center ms-auto">
        ...
        <div className="nav-item dropdown">
          <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">
            <img className="rounded-circle me-lg-2" src={`http://localhost:3003/upload/users/${user.Photo}`} alt style={{width: 35, height: 35}} />
            <span className="d-none d-lg-inline-flex">{userRole}</span>
          </a>
          <div className="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
            <a href="#" className="dropdown-item">My Profile</a>
            <a href="#" className="dropdown-item">Settings</a>
            <a onClick={()=>logout()} className="dropdown-item"style={{ color: "red" }}>Log Out</a>
          </div>
        </div>
      </div>
    </nav>
